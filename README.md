...
- **An LLM API key** — [Gemini](https://aistudio.google.com/apikey) (free, no credit card — recommended),[OpenAI](https://platform.openai.com/api-keys) or [Anthropic](https://console.anthropic.com/settings/keys)
